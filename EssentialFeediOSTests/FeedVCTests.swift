...
final class FeedVCTests: XCTestCase {
    ...
    private func assertThat(_ sut: FeedVC, isRendering feed: [FeedImage], file: StaticString = #file, line: UInt = #line) {
    ...
    private func assertThat(_ sut: FeedVC, hasViewConfiguredFor image: FeedImage, at index: Int, file: StaticString = #file, line: UInt = #line) {
    ...
    class LoaderSpy: FeedLoader, FeedImageDataLoader {
        ...
        func completeFeedLoading(with feed: [FeedImage] = [], at index: Int = 0) {
            print("count - \(feedRequests.count)")
